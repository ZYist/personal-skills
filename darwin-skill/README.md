...
原作者：[花叔 Huashu](https://github.com/alchaincyf)  
原仓库：https://github.com/alchaincyf/darwin-skill

本 fork 版本包含在 [ZYist/personal-skills](https://github.com/ZYist/personal-skills) 仓库中，遵循原项目 MIT 许可证。
